...
// Source: github.com/sogko/go-shopify-graphql (interfaces: ProductService)
...
import (
	...
	model "github.com/sogko/go-shopify-graphql/model"
)
...
func (m *MockProductService) Create(arg0 context.Context, arg1 model.ProductInput, arg2 []model.CreateMediaInput) (*model.Product, error) {
	m.ctrl.T.Helper()
...
func (m *MockProductService) Update(arg0 context.Context, arg1 model.ProductInput) (*model.Product, error) {
	m.ctrl.T.Helper()
